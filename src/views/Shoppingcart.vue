          ...
          <tr>
            ...
            <td class="cart_item_td">
              ...
              <div class="cart_controls">
                <button class="btn"><font-awesome-icon icon="fa-solid fa-minus" /></button>
                <span>1</span>
                <button class="btn"><font-awesome-icon icon="fa-solid fa-plus" /></button>
              </div>
            </td>
            <td class="cart_item_price">200</td>
            <td class="cart_item_trash">
              <button class="btn btn-trash"><font-awesome-icon icon="fa-solid fa-trash" /></button>
            </td>
          </tr>
        </tbody>
      </table>
